...
namespace CSMS.Entity.Migrations
{
    ...
    [Migration("20240810110104_AddAvatarUrlEntityForUser")]
    partial class AddAvatarUrlEntityForUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CSMS.Entity.CSMS_Entity.Document", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("Document", "csms");
                });

            modelBuilder.Entity("CSMS.Entity.CSMS_Entity.FileExtensions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CSMS.Entity.CSMS_Entity.ModelVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CSMS.Entity.CSMS_Entity.PushNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PushNotifications", "csms");
                });
            ...
            modelBuilder.Entity("CSMS.Entity.LogHistory.TransactionLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTimeOffset?>("CURRENT_TIMESTAMP")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("TransactionLog", "cms");
                });

            modelBuilder.Entity("CSMS.Entity.RoleProject.ActionProject", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("ActionProjects", "security_matrix_project");
                });

            modelBuilder.Entity("CSMS.Entity.RoleProject.ProjectUserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ProjectUserRoles", "security_matrix_project");
                });

            modelBuilder.Entity("CSMS.Entity.RoleProject.RoleProject", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("RoleProjects", "security_matrix_project");
                });

            modelBuilder.Entity("CSMS.Entity.RoleProject.SecurityMatrixProject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SecurityMatrixProjects", "security_matrix_project");
                });
            ...
            modelBuilder.Entity("CSMS.Entity.CSMS_Entity.Document", b =>
                {
                    b.HasOne("CSMS.Entity.CSMS_Entity.Document", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("CSMS.Entity.CSMS_Entity.PushNotification", b =>
                {
                    b.HasOne("CSMS.Entity.IdentityAccess.User", "AppUser")
            ...
            modelBuilder.Entity("CSMS.Entity.Issues.Comment", b =>
                {
                    ...
                    b.HasOne("CSMS.Entity.Issues.Comment", "Parent")
                        .WithMany("Comments")
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("CSMS.Entity.RoleProject.ProjectUserRole", b =>
                {
                    b.HasOne("CSMS.Entity.CSMS_Entity.Project", "Projects")
                        .WithMany("ProjectUserRoles")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSMS.Entity.RoleProject.RoleProject", "Roles")
                        .WithMany("ProjectUserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CSMS.Entity.IdentityAccess.User", "Users")
                        .WithMany("ProjectUserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CSMS.Entity.RoleProject.SecurityMatrixProject", b =>
                {
                    b.HasOne("CSMS.Entity.RoleProject.ActionProject", "Action")
                        .WithMany("SecurityMatrixProjects")
                        .HasForeignKey("ActionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSMS.Entity.RoleProject.RoleProject", "Role")
                        .WithMany("SecurityMatrixProjects")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CSMS.Entity.RoleProject.ActionProject", b =>
                {
                    b.Navigation("SecurityMatrixProjects");
                });
