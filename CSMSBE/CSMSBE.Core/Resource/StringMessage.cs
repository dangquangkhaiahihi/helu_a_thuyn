namespace CSMSBE.Core.Resource
{
    public class StringMessage
    {
        public static class ErrorMessages
        {
            ...
            public const string EmailAlreadyExits = "Email đã tồn tại.";
            public const string UserAlreadyExits = "Username đã tồn tại.";
            public const string EmailNotRegister = "Email này chưa được đăng kí.";
