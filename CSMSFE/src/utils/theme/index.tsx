...
import { PaletteMode, Shadows, SimplePaletteColorOptions } from '@mui/material';
...
declare module '@mui/material/styles' {
	...
	interface CustomPalette {
		...
		cuaternary: PaletteColorOptions;
...
const getTheme = () => {
	...
	const shadowDefaultConfig: Shadows = [
		"none",
  ...
  function MUITheme({ children }: MUIThemeProps) {
	return (
